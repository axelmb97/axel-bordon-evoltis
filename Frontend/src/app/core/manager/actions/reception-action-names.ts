export enum ReceptionActionName {
  LOAD_PAGINATED_PURCHASES = "[Recception index] Load paginated receptions",
  LOADED_PAGINATED_PURCHASES = "[Reception index] Loaded paginated receptions",
